...
$blue:    hsl(234, 100%, 60%); // #0d6efd;
$indigo:  #6610f2;
$purple:  hsl(281, 82%, 63%); // #6f42c1;
$pink:    #d63384;
$red:     hsl(339, 82%, 63%); // #dc3545;
$orange:  #fd7e14;
$yellow:  hsl(41, 82%, 63%); // #ffc107;
$green:   hsl(101, 82%, 63%); // #198754;
$teal:    #20c997;
$cyan:    #0dcaf0;
...
$primary:       $db-purple-300; // $blue (default)
$secondary:     $gray-600;
$success:       $green;
$info:          $blue;
$warning:       $yellow;
...
$body-color:                $db-bluishCyan-100; // $gray-900 (default)
$body-bg:                   $white;
...
$grid-gutter-width:           3rem; // 1.5rem (default)
$grid-row-columns:            6;
...
$border-style:                solid;
$border-color:                $gray-200; // $gray-300 (default)
...
$font-size-md:                $font-size-base * 1.125; // none (default)
$font-size-lg:                $font-size-base * 1.25;
$font-size-xl:                $font-size-base * 1.375; // none (default)
...
$headings-font-weight:        700; // 500 (default)
...
$lead-font-weight:            400; // 300 (default)
...
$input-btn-focus-width:         0; // $focus-ring-width (default)
...
$input-btn-focus-box-shadow:    none; //$focus-ring-box-shadow (default)
...
$card-border-color:                 $gray-200; // var(--#{$prefix}border-color-translucent) (default)
...
$alert-padding-x:               $spacer * 1.5; // $spacer (default)
$alert-margin-bottom:           0; // 1rem (default)
$alert-border-radius:           0; // $border-radius (default)
$alert-link-font-weight:        $font-weight-bold;
$alert-border-width:            0; // var(--#{$prefix}border-width) (default)
$alert-bg-scale:                -80%;
...
$offcanvas-horizontal-width:        332px; // 400px (default)
